...
final class PostController extends Controller
{
    ...
    {
        abort_unless((bool) auth('cms')->user()?->can('viewAny', CmsPost::class), 403);
    ...
    {
        abort_unless((bool) auth('cms')->user()?->can('create', CmsPost::class), 403);
    ...
    {
        abort_unless((bool) auth('cms')->user()?->can('update', $post), 403);
    ...
    {
        abort_unless((bool) auth('cms')->user()?->can('delete', $post), 403);
    ...
    {
        abort_unless((bool) auth('cms')->user()?->can('publish', $post), 403);
